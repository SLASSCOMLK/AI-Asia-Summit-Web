    ...
    <>
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          border: isHovered ? '2px solid #E8B84B' : '2px solid rgba(232, 184, 75, 0.75)',
          backgroundColor: isHovered ? 'rgba(232, 184, 75, 0.15)' : 'rgba(232, 184, 75, 0.08)',
          boxShadow: isHovered ? '0 0 16px rgba(232, 184, 75, 0.6)' : '0 0 12px rgba(232, 184, 75, 0.4)',
      ...
      <div
        style={{
          ...
          height: 8,
          borderRadius: '50%',
          backgroundColor: isHovered ? '#E8B84B' : '#E8B84B',
