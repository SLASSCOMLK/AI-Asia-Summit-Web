    ...
    <div className="squishy-pricing-wrapper">
      <div className="squishy-pricing-grid">
        <PricingCard
          ...
          availability="60 tickets available"
        ...
        <PricingCard
          badge="CORPORATE PASSES"
          label="Enterprise & Delegation"
          price="Custom"
          currency=""
          period="5+ Passes"
          description="Tailored corporate delegation packages, enterprise team passes, and VIP executive networking access."
          availability="Flexible Allocation"
          validity="Priority Booking Open"
          taxNote="*Inquire directly for bulk invoice"
