    ...
    <div className="group relative rounded-2xl border border-amber-400/25 bg-gradient-to-b from-[#1d1712]/95 via-[#15110d]/95 to-[#0f0c0a]/98 px-10 pt-10 pb-8 md:px-12 md:pt-12 md:pb-10 flex flex-col justify-between min-h-[420px] transition-all duration-300 hover:-translate-y-2 hover:border-amber-400/60 hover:shadow-[0_20px_50px_rgba(232,184,75,0.18)] backdrop-blur-2xl">
      ...
      <div>
        ...
        <div className="mb-9 flex items-center justify-between">
          <div className="flex size-[72px] items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400/20 to-amber-600/5 border border-amber-400/35 shadow-[0_0_24px_rgba(232,184,75,0.18)] transition-transform duration-300 group-hover:scale-105 group-hover:border-amber-400/70">
            <Icon className="size-9 text-[#E8B84B]" />
          </div>
      ...
      <div className="mt-auto pt-6 border-t border-amber-400/15 flex items-center justify-between text-xs text-slate-400 group-hover:text-slate-300">
