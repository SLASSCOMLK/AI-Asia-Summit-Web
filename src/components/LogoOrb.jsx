...
export default function LogoOrb({ className = '', hue = 0 }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error('Error initializing Logo Orb:', error);
  ...
  return <div ref={ctnDom} className={`logo-orb-canvas${className ? ` ${className}` : ''}`} />;
}
